...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-slate-50 to-sky-100 text-slate-900 flex flex-col">
      {/* Header / Navbar */}
      <header className="bg-white/90 backdrop-blur-md border-b border-slate-200/70 sticky top-0 z-30 shadow-[0_8px_20px_rgba(15,23,42,0.12)]">
      ...
      <main className="flex-1">
        {/* HERO – Orven-style: left text, right image, light background */}
        <section
          id="home"
          className="bg-gradient-to-r from-sky-50 via-white to-sky-50 border-b"
        >
          <div className="max-w-6xl mx-auto px-4 py-10 md:py-16 grid md:grid-cols-2 gap-10 items-center">
            {/* Left content */}
            <div className="space-y-5">
              <p className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-100 text-[11px] font-semibold text-sky-800 tracking-[0.18em] uppercase">
                <span className="h-1.5 w-1.5 rounded-full bg-sky-500" />
                Angular Pharmaceuticals
              </p>

              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-slate-900">
                Reliable formulations
                <br />
                for everyday practice.
              </h2>

              <p className="text-sm md:text-base text-slate-600 max-w-xl leading-6">
                Focused on Ortho, Gastro and Respiratory therapy segments with
                clinically relevant strengths, our brands are designed to
                support Indian clinicians and patients with dependable quality.
              </p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href="#contact"
                  className="px-5 py-2.5 rounded-full border border-sky-300 text-sky-800 text-sm font-semibold bg-white/70 shadow-[0_10px_25px_rgba(148,163,184,0.35)] hover:bg-sky-50 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
                >
                  Contact Us
                </a>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 pt-3">
                <div className="text-xs text-slate-600">
                  <div className="font-semibold text-sky-800">Ortho</div>
                  <div>Pain & inflammation care</div>
                </div>
                <div className="text-xs text-slate-600">
                  <div className="font-semibold text-sky-800">Gastro</div>
                  <div>Acid peptic management</div>
                </div>
                <div className="text-xs text-slate-600">
                  <div className="font-semibold text-sky-800">Respiratory</div>
                  <div>Allergy & airway support</div>
                </div>
              </div>
            </div>

            {/* Right image – family healthcare style */}
            <div className="flex justify-center md:justify-end">
              <div className="relative w-full max-w-md">
                <div className="absolute -inset-4 bg-sky-200/50 blur-3xl rounded-[40px] opacity-70" />
                <div className="relative rounded-[32px] overflow-hidden shadow-[0_22px_60px_rgba(15,23,42,0.35)] border border-sky-100 bg-slate-100">
                  <img
                    src="/family-hero.jpg"
                    alt="Family healthcare focus"
        ...
        {/* Banner before About – like Orven style */}
